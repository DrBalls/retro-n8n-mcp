...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/StopDebugTool](../README.md) / StopDebugTool

# Class: StopDebugTool

Defined in: [src/tools/debug/StopDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L4)
...
> **new StopDebugTool**(): `StopDebugTool`
...
> **description**: `string` = `'Stop and end a debug session'`

Defined in: [src/tools/debug/StopDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `sessionId`: `ZodString`; `stopExecution`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `sessionId`: `string`; `stopExecution`: `boolean`; \}, \{ `sessionId`: `string`; `stopExecution?`: `boolean`; \}\>

Defined in: [src/tools/debug/StopDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L8)
...
> **name**: `string` = `'debug_stop'`

Defined in: [src/tools/debug/StopDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L5)
...
Defined in: [src/tools/debug/StopDebugTool.ts:13](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L13)
...
Defined in: [src/tools/debug/StopDebugTool.ts:90](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StopDebugTool.ts#L90)
