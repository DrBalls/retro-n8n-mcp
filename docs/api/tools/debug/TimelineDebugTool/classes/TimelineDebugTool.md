...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/TimelineDebugTool](../README.md) / TimelineDebugTool

# Class: TimelineDebugTool

Defined in: [src/tools/debug/TimelineDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L4)
...
> **new TimelineDebugTool**(): `TimelineDebugTool`
...
> **description**: `string` = `'Generate execution timeline visualization showing the flow and timing of node executions'`

Defined in: [src/tools/debug/TimelineDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `format`: `ZodDefault`\<`ZodEnum`\<\[`"text"`, `"mermaid"`, `"json"`\]\>\>; `includeData`: `ZodDefault`\<`ZodBoolean`\>; `sessionId`: `ZodString`; `timeRange`: `ZodOptional`\<`ZodObject`\<\{ `end`: `ZodOptional`\<`ZodString`\>; `start`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `end?`: `string`; `start?`: `string`; \}, \{ `end?`: `string`; `start?`: `string`; \}\>\>; \}, `"strip"`, `ZodTypeAny`, \{ `format`: `"text"` \| `"json"` \| `"mermaid"`; `includeData`: `boolean`; `sessionId`: `string`; `timeRange?`: \{ `end?`: `string`; `start?`: `string`; \}; \}, \{ `format?`: `"text"` \| `"json"` \| `"mermaid"`; `includeData?`: `boolean`; `sessionId`: `string`; `timeRange?`: \{ `end?`: `string`; `start?`: `string`; \}; \}\>

Defined in: [src/tools/debug/TimelineDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L8)
...
> **name**: `string` = `'debug_timeline'`

Defined in: [src/tools/debug/TimelineDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L5)
...
Defined in: [src/tools/debug/TimelineDebugTool.ts:18](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L18)
...
Defined in: [src/tools/debug/TimelineDebugTool.ts:252](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/TimelineDebugTool.ts#L252)
