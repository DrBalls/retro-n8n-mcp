...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/StatusDebugTool](../README.md) / StatusDebugTool

# Class: StatusDebugTool

Defined in: [src/tools/debug/StatusDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L4)
...
> **new StatusDebugTool**(): `StatusDebugTool`
...
> **description**: `string` = `'Get the current status of debug sessions'`

Defined in: [src/tools/debug/StatusDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `sessionId`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `sessionId?`: `string`; \}, \{ `sessionId?`: `string`; \}\>

Defined in: [src/tools/debug/StatusDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L8)
...
> **name**: `string` = `'debug_status'`

Defined in: [src/tools/debug/StatusDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L5)
...
Defined in: [src/tools/debug/StatusDebugTool.ts:12](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L12)
...
Defined in: [src/tools/debug/StatusDebugTool.ts:151](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StatusDebugTool.ts#L151)
