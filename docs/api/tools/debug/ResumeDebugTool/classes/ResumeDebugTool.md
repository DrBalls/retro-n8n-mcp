...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/ResumeDebugTool](../README.md) / ResumeDebugTool

# Class: ResumeDebugTool

Defined in: [src/tools/debug/ResumeDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L4)
...
> **new ResumeDebugTool**(): `ResumeDebugTool`
...
> **description**: `string` = `'Resume normal execution in a paused debug session'`

Defined in: [src/tools/debug/ResumeDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `sessionId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `sessionId`: `string`; \}, \{ `sessionId`: `string`; \}\>

Defined in: [src/tools/debug/ResumeDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L8)
...
> **name**: `string` = `'debug_resume'`

Defined in: [src/tools/debug/ResumeDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L5)
...
Defined in: [src/tools/debug/ResumeDebugTool.ts:12](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L12)
...
Defined in: [src/tools/debug/ResumeDebugTool.ts:76](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/ResumeDebugTool.ts#L76)
