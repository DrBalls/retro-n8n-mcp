...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/WatchDebugTool](../README.md) / WatchDebugTool

# Class: WatchDebugTool

Defined in: [src/tools/debug/WatchDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L4)
...
> **new WatchDebugTool**(): `WatchDebugTool`
...
> **description**: `string` = `'Manage watch expressions to track variable values during debug execution'`

Defined in: [src/tools/debug/WatchDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `action`: `ZodEnum`\<\[`"add"`, `"remove"`, `"evaluate"`, `"list"`\]\>; `expression`: `ZodOptional`\<`ZodString`\>; `nodeId`: `ZodOptional`\<`ZodString`\>; `sessionId`: `ZodString`; `watchId`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `action`: `"add"` \| `"remove"` \| `"list"` \| `"evaluate"`; `expression?`: `string`; `nodeId?`: `string`; `sessionId`: `string`; `watchId?`: `string`; \}, \{ `action`: `"add"` \| `"remove"` \| `"list"` \| `"evaluate"`; `expression?`: `string`; `nodeId?`: `string`; `sessionId`: `string`; `watchId?`: `string`; \}\>

Defined in: [src/tools/debug/WatchDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L8)
...
> **name**: `string` = `'debug_watch'`

Defined in: [src/tools/debug/WatchDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L5)
...
Defined in: [src/tools/debug/WatchDebugTool.ts:16](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L16)
...
Defined in: [src/tools/debug/WatchDebugTool.ts:141](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/WatchDebugTool.ts#L141)
