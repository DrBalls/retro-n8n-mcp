...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/InspectDebugTool](../README.md) / InspectDebugTool

# Class: InspectDebugTool

Defined in: [src/tools/debug/InspectDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L4)
...
> **new InspectDebugTool**(): `InspectDebugTool`
...
> **description**: `string` = `'Inspect variables, node data, and execution state in a debug session'`

Defined in: [src/tools/debug/InspectDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `inspectType`: `ZodDefault`\<`ZodEnum`\<\[`"variable"`, `"node"`, `"timeline"`, `"state"`, `"all"`\]\>\>; `nodeId`: `ZodOptional`\<`ZodString`\>; `sessionId`: `ZodString`; `timeRange`: `ZodOptional`\<`ZodObject`\<\{ `end`: `ZodOptional`\<`ZodString`\>; `start`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `end?`: `string`; `start?`: `string`; \}, \{ `end?`: `string`; `start?`: `string`; \}\>\>; `variableName`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `inspectType`: `"node"` \| `"all"` \| `"variable"` \| `"timeline"` \| `"state"`; `nodeId?`: `string`; `sessionId`: `string`; `timeRange?`: \{ `end?`: `string`; `start?`: `string`; \}; `variableName?`: `string`; \}, \{ `inspectType?`: `"node"` \| `"all"` \| `"variable"` \| `"timeline"` \| `"state"`; `nodeId?`: `string`; `sessionId`: `string`; `timeRange?`: \{ `end?`: `string`; `start?`: `string`; \}; `variableName?`: `string`; \}\>

Defined in: [src/tools/debug/InspectDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L8)
...
> **name**: `string` = `'debug_inspect'`

Defined in: [src/tools/debug/InspectDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L5)
...
Defined in: [src/tools/debug/InspectDebugTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L19)
...
Defined in: [src/tools/debug/InspectDebugTool.ts:199](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/InspectDebugTool.ts#L199)
