...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/BreakpointDebugTool](../README.md) / BreakpointDebugTool

# Class: BreakpointDebugTool

Defined in: [src/tools/debug/BreakpointDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L4)
...
> **new BreakpointDebugTool**(): `BreakpointDebugTool`
...
> **description**: `string` = `'Manage breakpoints in a debug session (add, remove, enable, disable, list)'`

Defined in: [src/tools/debug/BreakpointDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `action`: `ZodEnum`\<\[`"add"`, `"remove"`, `"enable"`, `"disable"`, `"list"`\]\>; `breakpointId`: `ZodOptional`\<`ZodString`\>; `condition`: `ZodOptional`\<`ZodString`\>; `nodeId`: `ZodOptional`\<`ZodString`\>; `sessionId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `action`: `"add"` \| `"remove"` \| `"enable"` \| `"disable"` \| `"list"`; `breakpointId?`: `string`; `condition?`: `string`; `nodeId?`: `string`; `sessionId`: `string`; \}, \{ `action`: `"add"` \| `"remove"` \| `"enable"` \| `"disable"` \| `"list"`; `breakpointId?`: `string`; `condition?`: `string`; `nodeId?`: `string`; `sessionId`: `string`; \}\>

Defined in: [src/tools/debug/BreakpointDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L8)
...
> **name**: `string` = `'debug_breakpoint'`

Defined in: [src/tools/debug/BreakpointDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L5)
...
Defined in: [src/tools/debug/BreakpointDebugTool.ts:16](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L16)
...
Defined in: [src/tools/debug/BreakpointDebugTool.ts:144](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/BreakpointDebugTool.ts#L144)
