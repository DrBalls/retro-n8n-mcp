...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/debug/StepDebugTool](../README.md) / StepDebugTool

# Class: StepDebugTool

Defined in: [src/tools/debug/StepDebugTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L4)
...
> **new StepDebugTool**(): `StepDebugTool`
...
> **description**: `string` = `'Control step-through execution in a debug session (step over, into, or out)'`

Defined in: [src/tools/debug/StepDebugTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `sessionId`: `ZodString`; `stepType`: `ZodEnum`\<\[`"over"`, `"into"`, `"out"`\]\>; \}, `"strip"`, `ZodTypeAny`, \{ `sessionId`: `string`; `stepType`: `"over"` \| `"into"` \| `"out"`; \}, \{ `sessionId`: `string`; `stepType`: `"over"` \| `"into"` \| `"out"`; \}\>

Defined in: [src/tools/debug/StepDebugTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L8)
...
> **name**: `string` = `'debug_step'`

Defined in: [src/tools/debug/StepDebugTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L5)
...
Defined in: [src/tools/debug/StepDebugTool.ts:13](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L13)
...
Defined in: [src/tools/debug/StepDebugTool.ts:110](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/debug/StepDebugTool.ts#L110)
