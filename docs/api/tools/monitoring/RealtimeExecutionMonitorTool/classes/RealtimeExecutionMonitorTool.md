...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/monitoring/RealtimeExecutionMonitorTool](../README.md) / RealtimeExecutionMonitorTool

# Class: RealtimeExecutionMonitorTool

Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L5)
...
> **new RealtimeExecutionMonitorTool**(): `RealtimeExecutionMonitorTool`

#### Returns

`RealtimeExecutionMonitorTool`
...
> **description**: `string` = `'Monitor workflow execution in real-time with live updates via WebSocket/SSE or polling'`

Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `duration`: `ZodDefault`\<`ZodNumber`\>; `executionId`: `ZodString`; `includeProgress`: `ZodDefault`\<`ZodBoolean`\>; `protocol`: `ZodOptional`\<`ZodEnum`\<\[`"websocket"`, `"sse"`, `"polling"`\]\>\>; `updateInterval`: `ZodDefault`\<`ZodNumber`\>; \}, `"strip"`, `ZodTypeAny`, \{ `duration`: `number`; `executionId`: `string`; `includeProgress`: `boolean`; `protocol?`: `"websocket"` \| `"sse"` \| `"polling"`; `updateInterval`: `number`; \}, \{ `duration?`: `number`; `executionId`: `string`; `includeProgress?`: `boolean`; `protocol?`: `"websocket"` \| `"sse"` \| `"polling"`; `updateInterval?`: `number`; \}\>

Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L9)
...
> **name**: `string` = `'monitor_execution_realtime'`

Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L6)
...
Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:29](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L29)
...
Defined in: [src/tools/monitoring/RealtimeExecutionMonitorTool.ts:230](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/RealtimeExecutionMonitorTool.ts#L230)
