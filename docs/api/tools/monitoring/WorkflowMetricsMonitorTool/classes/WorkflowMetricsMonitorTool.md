...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/monitoring/WorkflowMetricsMonitorTool](../README.md) / WorkflowMetricsMonitorTool

# Class: WorkflowMetricsMonitorTool

Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L5)
...
> **new WorkflowMetricsMonitorTool**(): `WorkflowMetricsMonitorTool`

#### Returns

`WorkflowMetricsMonitorTool`
...
> **description**: `string` = `'Monitor real-time performance metrics and statistics for workflows'`

Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `duration`: `ZodDefault`\<`ZodNumber`\>; `includeHistorical`: `ZodDefault`\<`ZodBoolean`\>; `interval`: `ZodDefault`\<`ZodNumber`\>; `workflowId`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `duration`: `number`; `includeHistorical`: `boolean`; `interval`: `number`; `workflowId?`: `string`; \}, \{ `duration?`: `number`; `includeHistorical?`: `boolean`; `interval?`: `number`; `workflowId?`: `string`; \}\>

Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L9)
...
> **name**: `string` = `'monitor_workflow_metrics'`

Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L6)
...
Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:28](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L28)
...
Defined in: [src/tools/monitoring/WorkflowMetricsMonitorTool.ts:352](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/monitoring/WorkflowMetricsMonitorTool.ts#L352)
