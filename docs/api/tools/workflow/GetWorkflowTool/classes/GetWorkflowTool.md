...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/workflow/GetWorkflowTool](../README.md) / GetWorkflowTool

# Class: GetWorkflowTool

Defined in: [src/tools/workflow/GetWorkflowTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L7)
...
> **new GetWorkflowTool**(): `GetWorkflowTool`
...
> **description**: `string` = `'Get a single workflow by ID with full details'`

Defined in: [src/tools/workflow/GetWorkflowTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L9)
...
> **inputSchema**: `ZodObject`\<\{ `id`: `ZodString`; `includeNodes`: `ZodDefault`\<`ZodOptional`\<`ZodBoolean`\>\>; \}, `"strip"`, `ZodTypeAny`, \{ `id`: `string`; `includeNodes`: `boolean`; \}, \{ `id`: `string`; `includeNodes?`: `boolean`; \}\>

Defined in: [src/tools/workflow/GetWorkflowTool.ts:11](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L11)
...
> **name**: `string` = `'workflow_get'`

Defined in: [src/tools/workflow/GetWorkflowTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L8)
...
Defined in: [src/tools/workflow/GetWorkflowTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L19)
...
Defined in: [src/tools/workflow/GetWorkflowTool.ts:54](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/GetWorkflowTool.ts#L54)
