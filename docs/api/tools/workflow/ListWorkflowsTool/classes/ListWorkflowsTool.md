...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/workflow/ListWorkflowsTool](../README.md) / ListWorkflowsTool

# Class: ListWorkflowsTool

Defined in: [src/tools/workflow/ListWorkflowsTool.ts:20](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L20)
...
> **new ListWorkflowsTool**(): `ListWorkflowsTool`
...
> `readonly` **description**: `"List workflows from n8n with optional filters"` = `'List workflows from n8n with optional filters'`

Defined in: [src/tools/workflow/ListWorkflowsTool.ts:22](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L22)
...
> `readonly` **inputSchema**: `ZodObject`\<\{ `active`: `ZodOptional`\<`ZodBoolean`\>; `cursor`: `ZodOptional`\<`ZodString`\>; `limit`: `ZodDefault`\<`ZodNumber`\>; `tags`: `ZodOptional`\<`ZodArray`\<`ZodString`, `"many"`\>\>; \}, `"strip"`, `ZodTypeAny`, \{ `active?`: `boolean`; `cursor?`: `string`; `limit`: `number`; `tags?`: `string`[]; \}, \{ `active?`: `boolean`; `cursor?`: `string`; `limit?`: `number`; `tags?`: `string`[]; \}\> = `ListWorkflowsSchema`

Defined in: [src/tools/workflow/ListWorkflowsTool.ts:23](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L23)
...
> `readonly` **name**: `"workflow_list"` = `'workflow_list'`

Defined in: [src/tools/workflow/ListWorkflowsTool.ts:21](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L21)
...
Defined in: [src/tools/workflow/ListWorkflowsTool.ts:25](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L25)
...
Defined in: [src/tools/workflow/ListWorkflowsTool.ts:92](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L92)
...
Defined in: [src/tools/workflow/ListWorkflowsTool.ts:87](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/ListWorkflowsTool.ts#L87)
