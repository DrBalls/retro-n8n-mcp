...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/workflow/DeactivateWorkflowTool](../README.md) / DeactivateWorkflowTool

# Class: DeactivateWorkflowTool

Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L7)
...
> **new DeactivateWorkflowTool**(): `DeactivateWorkflowTool`
...
> **description**: `string` = `'Deactivate a workflow to stop automatic execution'`

Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L9)
...
> **inputSchema**: `ZodObject`\<\{ `id`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `id`: `string`; \}, \{ `id`: `string`; \}\>

Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:11](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L11)
...
> **name**: `string` = `'workflow_deactivate'`

Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L8)
...
Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:15](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L15)
...
Defined in: [src/tools/workflow/DeactivateWorkflowTool.ts:54](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/workflow/DeactivateWorkflowTool.ts#L54)
