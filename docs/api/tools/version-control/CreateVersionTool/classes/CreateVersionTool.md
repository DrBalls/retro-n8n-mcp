...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/CreateVersionTool](../README.md) / CreateVersionTool

# Class: CreateVersionTool

Defined in: [src/tools/version-control/CreateVersionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L5)
...
> **new CreateVersionTool**(): `CreateVersionTool`
...
> **description**: `string` = `'Create a new version of a workflow with semantic versioning, change tracking, and branch support'`

Defined in: [src/tools/version-control/CreateVersionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `branchName`: `ZodDefault`\<`ZodString`\>; `commitMessage`: `ZodOptional`\<`ZodString`\>; `isSnapshot`: `ZodDefault`\<`ZodBoolean`\>; `tags`: `ZodDefault`\<`ZodArray`\<`ZodString`, `"many"`\>\>; `versionIncrement`: `ZodDefault`\<`ZodEnum`\<\[`"major"`, `"minor"`, `"patch"`\]\>\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `branchName`: `string`; `commitMessage?`: `string`; `isSnapshot`: `boolean`; `tags`: `string`[]; `versionIncrement`: `"major"` \| `"minor"` \| `"patch"`; `workflowId`: `string`; \}, \{ `author?`: `string`; `branchName?`: `string`; `commitMessage?`: `string`; `isSnapshot?`: `boolean`; `tags?`: `string`[]; `versionIncrement?`: `"major"` \| `"minor"` \| `"patch"`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/CreateVersionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L9)
...
> **name**: `string` = `'version_control_create_version'`

Defined in: [src/tools/version-control/CreateVersionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L6)
...
Defined in: [src/tools/version-control/CreateVersionTool.ts:21](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L21)
...
Defined in: [src/tools/version-control/CreateVersionTool.ts:78](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateVersionTool.ts#L78)
