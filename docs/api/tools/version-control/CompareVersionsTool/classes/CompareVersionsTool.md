...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/CompareVersionsTool](../README.md) / CompareVersionsTool

# Class: CompareVersionsTool

Defined in: [src/tools/version-control/CompareVersionsTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L5)
...
> **new CompareVersionsTool**(): `CompareVersionsTool`
...
> **description**: `string` = `'Compare two workflow versions and generate detailed diff visualization'`

Defined in: [src/tools/version-control/CompareVersionsTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `format`: `ZodDefault`\<`ZodEnum`\<\[`"json"`, `"text"`, `"markdown"`\]\>\>; `fromVersionId`: `ZodString`; `includeMetadata`: `ZodDefault`\<`ZodBoolean`\>; `showOnlyChanges`: `ZodDefault`\<`ZodBoolean`\>; `toVersionId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `format`: `"text"` \| `"json"` \| `"markdown"`; `fromVersionId`: `string`; `includeMetadata`: `boolean`; `showOnlyChanges`: `boolean`; `toVersionId`: `string`; \}, \{ `format?`: `"text"` \| `"json"` \| `"markdown"`; `fromVersionId`: `string`; `includeMetadata?`: `boolean`; `showOnlyChanges?`: `boolean`; `toVersionId`: `string`; \}\>

Defined in: [src/tools/version-control/CompareVersionsTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L9)
...
> **name**: `string` = `'version_control_compare_versions'`

Defined in: [src/tools/version-control/CompareVersionsTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L6)
...
Defined in: [src/tools/version-control/CompareVersionsTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L19)
...
Defined in: [src/tools/version-control/CompareVersionsTool.ts:218](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CompareVersionsTool.ts#L218)
