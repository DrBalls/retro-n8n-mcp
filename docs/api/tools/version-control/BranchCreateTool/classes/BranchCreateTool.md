...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/BranchCreateTool](../README.md) / BranchCreateTool

# Class: BranchCreateTool

Defined in: [src/tools/version-control/BranchCreateTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L10)
...
> **new BranchCreateTool**(): `BranchCreateTool`
...
> **description**: `string` = `'Create a new workflow branch for feature development or experimentation'`

Defined in: [src/tools/version-control/BranchCreateTool.ts:12](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L12)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `autoSwitch`: `ZodDefault`\<`ZodBoolean`\>; `branchName`: `ZodString`; `description`: `ZodOptional`\<`ZodString`\>; `fromBranch`: `ZodDefault`\<`ZodString`\>; `fromVersionId`: `ZodOptional`\<`ZodString`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `autoSwitch`: `boolean`; `branchName`: `string`; `description?`: `string`; `fromBranch`: `string`; `fromVersionId?`: `string`; `workflowId`: `string`; \}, \{ `author?`: `string`; `autoSwitch?`: `boolean`; `branchName`: `string`; `description?`: `string`; `fromBranch?`: `string`; `fromVersionId?`: `string`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/BranchCreateTool.ts:17](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L17)
...
> **name**: `string` = `'branch_create'`

Defined in: [src/tools/version-control/BranchCreateTool.ts:11](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L11)
...
Defined in: [src/tools/version-control/BranchCreateTool.ts:27](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L27)
...
Defined in: [src/tools/version-control/BranchCreateTool.ts:176](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchCreateTool.ts#L176)
