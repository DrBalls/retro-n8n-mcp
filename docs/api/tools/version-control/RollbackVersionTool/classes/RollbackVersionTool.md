...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/RollbackVersionTool](../README.md) / RollbackVersionTool

# Class: RollbackVersionTool

Defined in: [src/tools/version-control/RollbackVersionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L5)
...
> **new RollbackVersionTool**(): `RollbackVersionTool`
...
> **description**: `string` = `'Rollback a workflow to a specific previous version with backup creation'`

Defined in: [src/tools/version-control/RollbackVersionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `branchName`: `ZodDefault`\<`ZodString`\>; `commitMessage`: `ZodOptional`\<`ZodString`\>; `createBackup`: `ZodDefault`\<`ZodBoolean`\>; `dryRun`: `ZodDefault`\<`ZodBoolean`\>; `targetVersionId`: `ZodString`; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `branchName`: `string`; `commitMessage?`: `string`; `createBackup`: `boolean`; `dryRun`: `boolean`; `targetVersionId`: `string`; `workflowId`: `string`; \}, \{ `author?`: `string`; `branchName?`: `string`; `commitMessage?`: `string`; `createBackup?`: `boolean`; `dryRun?`: `boolean`; `targetVersionId`: `string`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/RollbackVersionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L9)
...
> **name**: `string` = `'version_control_rollback'`

Defined in: [src/tools/version-control/RollbackVersionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L6)
...
Defined in: [src/tools/version-control/RollbackVersionTool.ts:21](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L21)
...
Defined in: [src/tools/version-control/RollbackVersionTool.ts:137](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/RollbackVersionTool.ts#L137)
