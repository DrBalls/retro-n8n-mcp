...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/ListVersionsTool](../README.md) / ListVersionsTool

# Class: ListVersionsTool

Defined in: [src/tools/version-control/ListVersionsTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L5)
...
> **new ListVersionsTool**(): `ListVersionsTool`
...
> **description**: `string` = `'List all versions of a workflow with filtering and pagination options'`

Defined in: [src/tools/version-control/ListVersionsTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `branchName`: `ZodOptional`\<`ZodString`\>; `includeDetails`: `ZodDefault`\<`ZodBoolean`\>; `includeSnapshots`: `ZodDefault`\<`ZodBoolean`\>; `limit`: `ZodDefault`\<`ZodNumber`\>; `offset`: `ZodDefault`\<`ZodNumber`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `branchName?`: `string`; `includeDetails`: `boolean`; `includeSnapshots`: `boolean`; `limit`: `number`; `offset`: `number`; `workflowId`: `string`; \}, \{ `branchName?`: `string`; `includeDetails?`: `boolean`; `includeSnapshots?`: `boolean`; `limit?`: `number`; `offset?`: `number`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/ListVersionsTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L9)
...
> **name**: `string` = `'version_control_list_versions'`

Defined in: [src/tools/version-control/ListVersionsTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L6)
...
Defined in: [src/tools/version-control/ListVersionsTool.ts:20](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L20)
...
Defined in: [src/tools/version-control/ListVersionsTool.ts:90](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/ListVersionsTool.ts#L90)
