...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/CreateBranchTool](../README.md) / CreateBranchTool

# Class: CreateBranchTool

Defined in: [src/tools/version-control/CreateBranchTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L5)
...
> **new CreateBranchTool**(): `CreateBranchTool`
...
> **description**: `string` = `'Create a new branch for workflow development with optional base version'`

Defined in: [src/tools/version-control/CreateBranchTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `baseVersionId`: `ZodOptional`\<`ZodString`\>; `branchName`: `ZodString`; `createdBy`: `ZodOptional`\<`ZodString`\>; `description`: `ZodOptional`\<`ZodString`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `baseVersionId?`: `string`; `branchName`: `string`; `createdBy?`: `string`; `description?`: `string`; `workflowId`: `string`; \}, \{ `baseVersionId?`: `string`; `branchName`: `string`; `createdBy?`: `string`; `description?`: `string`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/CreateBranchTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L9)
...
> **name**: `string` = `'version_control_create_branch'`

Defined in: [src/tools/version-control/CreateBranchTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L6)
...
Defined in: [src/tools/version-control/CreateBranchTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L19)
...
Defined in: [src/tools/version-control/CreateBranchTool.ts:71](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/CreateBranchTool.ts#L71)
