...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/VersionHistoryTool](../README.md) / VersionHistoryTool

# Class: VersionHistoryTool

Defined in: [src/tools/version-control/VersionHistoryTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L10)
...
> **new VersionHistoryTool**(): `VersionHistoryTool`
...
> **description**: `string` = `'Get version history for a workflow with Git-like log functionality and filtering'`

Defined in: [src/tools/version-control/VersionHistoryTool.ts:12](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L12)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `branch`: `ZodOptional`\<`ZodString`\>; `format`: `ZodDefault`\<`ZodEnum`\<\[`"detailed"`, `"summary"`, `"oneline"`\]\>\>; `includeChanges`: `ZodDefault`\<`ZodBoolean`\>; `includeTags`: `ZodDefault`\<`ZodBoolean`\>; `limit`: `ZodDefault`\<`ZodNumber`\>; `offset`: `ZodDefault`\<`ZodNumber`\>; `since`: `ZodOptional`\<`ZodNumber`\>; `until`: `ZodOptional`\<`ZodNumber`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `branch?`: `string`; `format`: `"summary"` \| `"detailed"` \| `"oneline"`; `includeChanges`: `boolean`; `includeTags`: `boolean`; `limit`: `number`; `offset`: `number`; `since?`: `number`; `until?`: `number`; `workflowId`: `string`; \}, \{ `author?`: `string`; `branch?`: `string`; `format?`: `"summary"` \| `"detailed"` \| `"oneline"`; `includeChanges?`: `boolean`; `includeTags?`: `boolean`; `limit?`: `number`; `offset?`: `number`; `since?`: `number`; `until?`: `number`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/VersionHistoryTool.ts:17](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L17)
...
> **name**: `string` = `'version_history'`

Defined in: [src/tools/version-control/VersionHistoryTool.ts:11](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L11)
...
Defined in: [src/tools/version-control/VersionHistoryTool.ts:30](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L30)
...
Defined in: [src/tools/version-control/VersionHistoryTool.ts:207](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/VersionHistoryTool.ts#L207)
