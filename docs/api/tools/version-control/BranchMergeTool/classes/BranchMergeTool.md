...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/BranchMergeTool](../README.md) / BranchMergeTool

# Class: BranchMergeTool

Defined in: [src/tools/version-control/BranchMergeTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L10)
...
> **new BranchMergeTool**(): `BranchMergeTool`
...
> **description**: `string` = `'Merge a source branch into a target branch with conflict detection and resolution'`

Defined in: [src/tools/version-control/BranchMergeTool.ts:12](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L12)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `autoResolve`: `ZodDefault`\<`ZodBoolean`\>; `createBackup`: `ZodDefault`\<`ZodBoolean`\>; `deleteSourceBranch`: `ZodDefault`\<`ZodBoolean`\>; `message`: `ZodOptional`\<`ZodString`\>; `sourceBranch`: `ZodString`; `strategy`: `ZodDefault`\<`ZodEnum`\<\[`"auto"`, `"manual"`, `"ours"`, `"theirs"`\]\>\>; `targetBranch`: `ZodDefault`\<`ZodString`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `autoResolve`: `boolean`; `createBackup`: `boolean`; `deleteSourceBranch`: `boolean`; `message?`: `string`; `sourceBranch`: `string`; `strategy`: `"manual"` \| `"auto"` \| `"ours"` \| `"theirs"`; `targetBranch`: `string`; `workflowId`: `string`; \}, \{ `author?`: `string`; `autoResolve?`: `boolean`; `createBackup?`: `boolean`; `deleteSourceBranch?`: `boolean`; `message?`: `string`; `sourceBranch`: `string`; `strategy?`: `"manual"` \| `"auto"` \| `"ours"` \| `"theirs"`; `targetBranch?`: `string`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/BranchMergeTool.ts:17](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L17)
...
> **name**: `string` = `'branch_merge'`

Defined in: [src/tools/version-control/BranchMergeTool.ts:11](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L11)
...
Defined in: [src/tools/version-control/BranchMergeTool.ts:31](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L31)
...
Defined in: [src/tools/version-control/BranchMergeTool.ts:243](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/BranchMergeTool.ts#L243)
