...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/version-control/MergeBranchTool](../README.md) / MergeBranchTool

# Class: MergeBranchTool

Defined in: [src/tools/version-control/MergeBranchTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L5)
...
> **new MergeBranchTool**(): `MergeBranchTool`
...
> **description**: `string` = `'Merge one branch into another with conflict detection and resolution strategies'`

Defined in: [src/tools/version-control/MergeBranchTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `author`: `ZodOptional`\<`ZodString`\>; `commitMessage`: `ZodOptional`\<`ZodString`\>; `deleteSourceBranch`: `ZodDefault`\<`ZodBoolean`\>; `dryRun`: `ZodDefault`\<`ZodBoolean`\>; `sourceBranchName`: `ZodString`; `strategy`: `ZodDefault`\<`ZodEnum`\<\[`"auto"`, `"manual"`, `"ours"`, `"theirs"`\]\>\>; `targetBranchName`: `ZodDefault`\<`ZodString`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `author?`: `string`; `commitMessage?`: `string`; `deleteSourceBranch`: `boolean`; `dryRun`: `boolean`; `sourceBranchName`: `string`; `strategy`: `"manual"` \| `"auto"` \| `"ours"` \| `"theirs"`; `targetBranchName`: `string`; `workflowId`: `string`; \}, \{ `author?`: `string`; `commitMessage?`: `string`; `deleteSourceBranch?`: `boolean`; `dryRun?`: `boolean`; `sourceBranchName`: `string`; `strategy?`: `"manual"` \| `"auto"` \| `"ours"` \| `"theirs"`; `targetBranchName?`: `string`; `workflowId`: `string`; \}\>

Defined in: [src/tools/version-control/MergeBranchTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L9)
...
> **name**: `string` = `'version_control_merge_branch'`

Defined in: [src/tools/version-control/MergeBranchTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L6)
...
Defined in: [src/tools/version-control/MergeBranchTool.ts:22](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L22)
...
Defined in: [src/tools/version-control/MergeBranchTool.ts:111](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/version-control/MergeBranchTool.ts#L111)
