...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/credential/ListCredentialsTool](../README.md) / ListCredentialsTool

# Class: ListCredentialsTool

Defined in: [src/tools/credential/ListCredentialsTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L4)
...
> **new ListCredentialsTool**(): `ListCredentialsTool`
...
> **description**: `string` = `'List all credentials with filtering options'`

Defined in: [src/tools/credential/ListCredentialsTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `includeData`: `ZodOptional`\<`ZodBoolean`\>; `search`: `ZodOptional`\<`ZodString`\>; `tags`: `ZodOptional`\<`ZodArray`\<`ZodString`, `"many"`\>\>; `type`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `includeData?`: `boolean`; `search?`: `string`; `tags?`: `string`[]; `type?`: `string`; \}, \{ `includeData?`: `boolean`; `search?`: `string`; `tags?`: `string`[]; `type?`: `string`; \}\>

Defined in: [src/tools/credential/ListCredentialsTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L8)
...
> **name**: `string` = `'credential_list'`

Defined in: [src/tools/credential/ListCredentialsTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L5)
...
Defined in: [src/tools/credential/ListCredentialsTool.ts:15](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L15)
...
Defined in: [src/tools/credential/ListCredentialsTool.ts:99](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/ListCredentialsTool.ts#L99)
