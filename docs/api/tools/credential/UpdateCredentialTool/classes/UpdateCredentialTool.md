...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/credential/UpdateCredentialTool](../README.md) / UpdateCredentialTool

# Class: UpdateCredentialTool

Defined in: [src/tools/credential/UpdateCredentialTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L4)
...
> **new UpdateCredentialTool**(): `UpdateCredentialTool`
...
> **description**: `string` = `'Update an existing credential with security checks'`

Defined in: [src/tools/credential/UpdateCredentialTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `data`: `ZodOptional`\<`ZodRecord`\<`ZodString`, `ZodUnknown`\>\>; `id`: `ZodString`; `name`: `ZodOptional`\<`ZodString`\>; `nodesAccess`: `ZodOptional`\<`ZodArray`\<`ZodObject`\<\{ `date`: `ZodOptional`\<`ZodString`\>; `nodeType`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `date?`: `string`; `nodeType`: `string`; \}, \{ `date?`: `string`; `nodeType`: `string`; \}\>, `"many"`\>\>; `tags`: `ZodOptional`\<`ZodArray`\<`ZodString`, `"many"`\>\>; \}, `"strip"`, `ZodTypeAny`, \{ `data?`: `Record`\<`string`, `unknown`\>; `id`: `string`; `name?`: `string`; `nodesAccess?`: `object`[]; `tags?`: `string`[]; \}, \{ `data?`: `Record`\<`string`, `unknown`\>; `id`: `string`; `name?`: `string`; `nodesAccess?`: `object`[]; `tags?`: `string`[]; \}\>

Defined in: [src/tools/credential/UpdateCredentialTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L8)
...
> **name**: `string` = `'credential_update'`

Defined in: [src/tools/credential/UpdateCredentialTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L5)
...
Defined in: [src/tools/credential/UpdateCredentialTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L19)
...
Defined in: [src/tools/credential/UpdateCredentialTool.ts:81](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/UpdateCredentialTool.ts#L81)
