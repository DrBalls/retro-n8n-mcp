...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/credential/DeleteCredentialTool](../README.md) / DeleteCredentialTool

# Class: DeleteCredentialTool

Defined in: [src/tools/credential/DeleteCredentialTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L4)
...
> **new DeleteCredentialTool**(): `DeleteCredentialTool`
...
> **description**: `string` = `'Delete a credential permanently from n8n'`

Defined in: [src/tools/credential/DeleteCredentialTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `force`: `ZodOptional`\<`ZodBoolean`\>; `id`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `force?`: `boolean`; `id`: `string`; \}, \{ `force?`: `boolean`; `id`: `string`; \}\>

Defined in: [src/tools/credential/DeleteCredentialTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L8)
...
> **name**: `string` = `'credential_delete'`

Defined in: [src/tools/credential/DeleteCredentialTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L5)
...
Defined in: [src/tools/credential/DeleteCredentialTool.ts:13](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L13)
...
Defined in: [src/tools/credential/DeleteCredentialTool.ts:84](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/DeleteCredentialTool.ts#L84)
