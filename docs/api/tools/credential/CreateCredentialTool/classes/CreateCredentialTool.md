...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/credential/CreateCredentialTool](../README.md) / CreateCredentialTool

# Class: CreateCredentialTool

Defined in: [src/tools/credential/CreateCredentialTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L4)
...
> **new CreateCredentialTool**(): `CreateCredentialTool`
...
> **description**: `string` = `'Create a new credential in n8n with encryption and validation'`

Defined in: [src/tools/credential/CreateCredentialTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `data`: `ZodRecord`\<`ZodString`, `ZodUnknown`\>; `name`: `ZodString`; `nodesAccess`: `ZodOptional`\<`ZodArray`\<`ZodObject`\<\{ `date`: `ZodOptional`\<`ZodString`\>; `nodeType`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `date?`: `string`; `nodeType`: `string`; \}, \{ `date?`: `string`; `nodeType`: `string`; \}\>, `"many"`\>\>; `tags`: `ZodOptional`\<`ZodArray`\<`ZodString`, `"many"`\>\>; `type`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `data`: `Record`\<`string`, `unknown`\>; `name`: `string`; `nodesAccess?`: `object`[]; `tags?`: `string`[]; `type`: `string`; \}, \{ `data`: `Record`\<`string`, `unknown`\>; `name`: `string`; `nodesAccess?`: `object`[]; `tags?`: `string`[]; `type`: `string`; \}\>

Defined in: [src/tools/credential/CreateCredentialTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L8)
...
> **name**: `string` = `'credential_create'`

Defined in: [src/tools/credential/CreateCredentialTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L5)
...
Defined in: [src/tools/credential/CreateCredentialTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L19)
...
Defined in: [src/tools/credential/CreateCredentialTool.ts:80](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/CreateCredentialTool.ts#L80)
