...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/credential/GetCredentialTool](../README.md) / GetCredentialTool

# Class: GetCredentialTool

Defined in: [src/tools/credential/GetCredentialTool.ts:4](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L4)
...
> **new GetCredentialTool**(): `GetCredentialTool`
...
> **description**: `string` = `'Get detailed information about a specific credential'`

Defined in: [src/tools/credential/GetCredentialTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L6)
...
> **inputSchema**: `ZodObject`\<\{ `id`: `ZodString`; `includeData`: `ZodOptional`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `id`: `string`; `includeData?`: `boolean`; \}, \{ `id`: `string`; `includeData?`: `boolean`; \}\>

Defined in: [src/tools/credential/GetCredentialTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L8)
...
> **name**: `string` = `'credential_get'`

Defined in: [src/tools/credential/GetCredentialTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L5)
...
Defined in: [src/tools/credential/GetCredentialTool.ts:13](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L13)
...
Defined in: [src/tools/credential/GetCredentialTool.ts:94](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/credential/GetCredentialTool.ts#L94)
