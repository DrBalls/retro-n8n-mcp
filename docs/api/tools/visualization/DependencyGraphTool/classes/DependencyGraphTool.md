...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/visualization/DependencyGraphTool](../README.md) / DependencyGraphTool

# Class: DependencyGraphTool

Defined in: [src/tools/visualization/DependencyGraphTool.ts:16](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L16)
...
> **new DependencyGraphTool**(): `DependencyGraphTool`
...
> **description**: `string` = `'Generate a dependency graph showing node relationships, execution order, and data flow paths'`

Defined in: [src/tools/visualization/DependencyGraphTool.ts:18](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L18)
...
> **inputSchema**: `ZodObject`\<\{ `format`: `ZodDefault`\<`ZodEnum`\<\[`"json"`, `"dot"`, `"mermaid"`\]\>\>; `groupByType`: `ZodDefault`\<`ZodBoolean`\>; `highlightCriticalPath`: `ZodDefault`\<`ZodBoolean`\>; `layout`: `ZodDefault`\<`ZodEnum`\<\[`"hierarchical"`, `"circular"`, `"force-directed"`\]\>\>; `showDataTypes`: `ZodDefault`\<`ZodBoolean`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `format`: `"json"` \| `"mermaid"` \| `"dot"`; `groupByType`: `boolean`; `highlightCriticalPath`: `boolean`; `layout`: `"hierarchical"` \| `"circular"` \| `"force-directed"`; `showDataTypes`: `boolean`; `workflowId`: `string`; \}, \{ `format?`: `"json"` \| `"mermaid"` \| `"dot"`; `groupByType?`: `boolean`; `highlightCriticalPath?`: `boolean`; `layout?`: `"hierarchical"` \| `"circular"` \| `"force-directed"`; `showDataTypes?`: `boolean`; `workflowId`: `string`; \}\>

Defined in: [src/tools/visualization/DependencyGraphTool.ts:20](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L20)
...
> **name**: `string` = `'visualization_dependency_graph'`

Defined in: [src/tools/visualization/DependencyGraphTool.ts:17](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L17)
...
Defined in: [src/tools/visualization/DependencyGraphTool.ts:29](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L29)
...
Defined in: [src/tools/visualization/DependencyGraphTool.ts:594](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/visualization/DependencyGraphTool.ts#L594)
