...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/batch/BatchWorkflowsDeleteTool](../README.md) / BatchWorkflowsDeleteTool

# Class: BatchWorkflowsDeleteTool

Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L6)
...
> **new BatchWorkflowsDeleteTool**(): `BatchWorkflowsDeleteTool`
...
> **description**: `string` = `'Delete multiple workflows in a single batch operation with safety checks'`

Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L8)
...
> **inputSchema**: `ZodObject`\<\{ `options`: `ZodOptional`\<`ZodObject`\<\{ `concurrency`: `ZodDefault`\<`ZodNumber`\>; `dryRun`: `ZodDefault`\<`ZodBoolean`\>; `force`: `ZodDefault`\<`ZodBoolean`\>; `skipActiveCheck`: `ZodDefault`\<`ZodBoolean`\>; `stopOnError`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `concurrency`: `number`; `dryRun`: `boolean`; `force`: `boolean`; `skipActiveCheck`: `boolean`; `stopOnError`: `boolean`; \}, \{ `concurrency?`: `number`; `dryRun?`: `boolean`; `force?`: `boolean`; `skipActiveCheck?`: `boolean`; `stopOnError?`: `boolean`; \}\>\>; `workflowIds`: `ZodArray`\<`ZodString`, `"many"`\>; \}, `"strip"`, `ZodTypeAny`, \{ `options?`: \{ `concurrency`: `number`; `dryRun`: `boolean`; `force`: `boolean`; `skipActiveCheck`: `boolean`; `stopOnError`: `boolean`; \}; `workflowIds`: `string`[]; \}, \{ `options?`: \{ `concurrency?`: `number`; `dryRun?`: `boolean`; `force?`: `boolean`; `skipActiveCheck?`: `boolean`; `stopOnError?`: `boolean`; \}; `workflowIds`: `string`[]; \}\>

Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L10)
...
> **name**: `string` = `'batch_workflows_delete'`

Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L7)
...
Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:25](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L25)
...
Defined in: [src/tools/batch/BatchWorkflowsDeleteTool.ts:290](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeleteTool.ts#L290)
