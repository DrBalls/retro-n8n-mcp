...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/batch/BatchWorkflowsDeactivateTool](../README.md) / BatchWorkflowsDeactivateTool

# Class: BatchWorkflowsDeactivateTool

Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L6)
...
> **new BatchWorkflowsDeactivateTool**(): `BatchWorkflowsDeactivateTool`
...
> **description**: `string` = `'Deactivate multiple workflows in a single batch operation'`

Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L8)
...
> **inputSchema**: `ZodObject`\<\{ `options`: `ZodOptional`\<`ZodObject`\<\{ `concurrency`: `ZodDefault`\<`ZodNumber`\>; `stopOnError`: `ZodDefault`\<`ZodBoolean`\>; `stopRunningExecutions`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `concurrency`: `number`; `stopOnError`: `boolean`; `stopRunningExecutions`: `boolean`; \}, \{ `concurrency?`: `number`; `stopOnError?`: `boolean`; `stopRunningExecutions?`: `boolean`; \}\>\>; `workflowIds`: `ZodArray`\<`ZodString`, `"many"`\>; \}, `"strip"`, `ZodTypeAny`, \{ `options?`: \{ `concurrency`: `number`; `stopOnError`: `boolean`; `stopRunningExecutions`: `boolean`; \}; `workflowIds`: `string`[]; \}, \{ `options?`: \{ `concurrency?`: `number`; `stopOnError?`: `boolean`; `stopRunningExecutions?`: `boolean`; \}; `workflowIds`: `string`[]; \}\>

Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L10)
...
> **name**: `string` = `'batch_workflows_deactivate'`

Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L7)
...
Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:23](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L23)
...
Defined in: [src/tools/batch/BatchWorkflowsDeactivateTool.ts:348](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsDeactivateTool.ts#L348)
