...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/batch/BatchWorkflowsCreateTool](../README.md) / BatchWorkflowsCreateTool

# Class: BatchWorkflowsCreateTool

Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L6)
...
> **new BatchWorkflowsCreateTool**(): `BatchWorkflowsCreateTool`
...
> **description**: `string` = `'Create multiple workflows in a single batch operation with atomic transaction support'`

Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L8)
...
> **inputSchema**: `ZodObject`\<\{ `options`: `ZodOptional`\<`ZodObject`\<\{ `atomic`: `ZodDefault`\<`ZodBoolean`\>; `concurrency`: `ZodDefault`\<`ZodNumber`\>; `stopOnError`: `ZodDefault`\<`ZodBoolean`\>; `validateWorkflows`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `atomic`: `boolean`; `concurrency`: `number`; `stopOnError`: `boolean`; `validateWorkflows`: `boolean`; \}, \{ `atomic?`: `boolean`; `concurrency?`: `number`; `stopOnError?`: `boolean`; `validateWorkflows?`: `boolean`; \}\>\>; `workflows`: `ZodArray`\<`ZodObject`\<\{ `active`: `ZodDefault`\<`ZodBoolean`\>; `connections`: `ZodRecord`\<`ZodString`, `ZodAny`\>; `name`: `ZodString`; `nodes`: `ZodArray`\<`ZodAny`, `"many"`\>; `settings`: `ZodOptional`\<`ZodRecord`\<`ZodString`, `ZodAny`\>\>; `staticData`: `ZodOptional`\<`ZodRecord`\<`ZodString`, `ZodAny`\>\>; `tags`: `ZodOptional`\<`ZodArray`\<`ZodString`, `"many"`\>\>; \}, `"strip"`, `ZodTypeAny`, \{ `active`: `boolean`; `connections`: `Record`\<`string`, `any`\>; `name`: `string`; `nodes`: `any`[]; `settings?`: `Record`\<`string`, `any`\>; `staticData?`: `Record`\<`string`, `any`\>; `tags?`: `string`[]; \}, \{ `active?`: `boolean`; `connections`: `Record`\<`string`, `any`\>; `name`: `string`; `nodes`: `any`[]; `settings?`: `Record`\<`string`, `any`\>; `staticData?`: `Record`\<`string`, `any`\>; `tags?`: `string`[]; \}\>, `"many"`\>; \}, `"strip"`, `ZodTypeAny`, \{ `options?`: \{ `atomic`: `boolean`; `concurrency`: `number`; `stopOnError`: `boolean`; `validateWorkflows`: `boolean`; \}; `workflows`: `object`[]; \}, \{ `options?`: \{ `atomic?`: `boolean`; `concurrency?`: `number`; `stopOnError?`: `boolean`; `validateWorkflows?`: `boolean`; \}; `workflows`: `object`[]; \}\>

Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L10)
...
> **name**: `string` = `'batch_workflows_create'`

Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L7)
...
Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:29](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L29)
...
Defined in: [src/tools/batch/BatchWorkflowsCreateTool.ts:218](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsCreateTool.ts#L218)
