...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/batch/BatchWorkflowsActivateTool](../README.md) / BatchWorkflowsActivateTool

# Class: BatchWorkflowsActivateTool

Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L6)
...
> **new BatchWorkflowsActivateTool**(): `BatchWorkflowsActivateTool`
...
> **description**: `string` = `'Activate multiple workflows in a single batch operation'`

Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:8](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L8)
...
> **inputSchema**: `ZodObject`\<\{ `options`: `ZodOptional`\<`ZodObject`\<\{ `concurrency`: `ZodDefault`\<`ZodNumber`\>; `skipValidation`: `ZodDefault`\<`ZodBoolean`\>; `stopOnError`: `ZodDefault`\<`ZodBoolean`\>; `testRun`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `concurrency`: `number`; `skipValidation`: `boolean`; `stopOnError`: `boolean`; `testRun`: `boolean`; \}, \{ `concurrency?`: `number`; `skipValidation?`: `boolean`; `stopOnError?`: `boolean`; `testRun?`: `boolean`; \}\>\>; `workflowIds`: `ZodArray`\<`ZodString`, `"many"`\>; \}, `"strip"`, `ZodTypeAny`, \{ `options?`: \{ `concurrency`: `number`; `skipValidation`: `boolean`; `stopOnError`: `boolean`; `testRun`: `boolean`; \}; `workflowIds`: `string`[]; \}, \{ `options?`: \{ `concurrency?`: `number`; `skipValidation?`: `boolean`; `stopOnError?`: `boolean`; `testRun?`: `boolean`; \}; `workflowIds`: `string`[]; \}\>

Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:10](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L10)
...
> **name**: `string` = `'batch_workflows_activate'`

Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L7)
...
Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:24](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L24)
...
Defined in: [src/tools/batch/BatchWorkflowsActivateTool.ts:320](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchWorkflowsActivateTool.ts#L320)
