...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/batch/BatchOperationStatusTool](../README.md) / BatchOperationStatusTool

# Class: BatchOperationStatusTool

Defined in: [src/tools/batch/BatchOperationStatusTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L5)
...
> **new BatchOperationStatusTool**(): `BatchOperationStatusTool`
...
> **description**: `string` = `'Get the status and progress of a batch operation or list all active operations'`

Defined in: [src/tools/batch/BatchOperationStatusTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `includeDetails`: `ZodDefault`\<`ZodBoolean`\>; `listActive`: `ZodDefault`\<`ZodBoolean`\>; `operationId`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `includeDetails`: `boolean`; `listActive`: `boolean`; `operationId?`: `string`; \}, \{ `includeDetails?`: `boolean`; `listActive?`: `boolean`; `operationId?`: `string`; \}\>

Defined in: [src/tools/batch/BatchOperationStatusTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L9)
...
> **name**: `string` = `'batch_operation_status'`

Defined in: [src/tools/batch/BatchOperationStatusTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L6)
...
Defined in: [src/tools/batch/BatchOperationStatusTool.ts:15](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L15)
...
Defined in: [src/tools/batch/BatchOperationStatusTool.ts:216](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/batch/BatchOperationStatusTool.ts#L216)
