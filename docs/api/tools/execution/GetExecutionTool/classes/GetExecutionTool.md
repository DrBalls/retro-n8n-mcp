...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/GetExecutionTool](../README.md) / GetExecutionTool

# Class: GetExecutionTool

Defined in: [src/tools/execution/GetExecutionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L5)
...
> **new GetExecutionTool**(): `GetExecutionTool`
...
> **description**: `string` = `'Get detailed information about a specific workflow execution'`

Defined in: [src/tools/execution/GetExecutionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `executionId`: `ZodString`; `includeData`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `executionId`: `string`; `includeData`: `boolean`; \}, \{ `executionId`: `string`; `includeData?`: `boolean`; \}\>

Defined in: [src/tools/execution/GetExecutionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L9)
...
> **name**: `string` = `'get_execution'`

Defined in: [src/tools/execution/GetExecutionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L6)
...
Defined in: [src/tools/execution/GetExecutionTool.ts:16](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L16)
...
Defined in: [src/tools/execution/GetExecutionTool.ts:94](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/GetExecutionTool.ts#L94)
