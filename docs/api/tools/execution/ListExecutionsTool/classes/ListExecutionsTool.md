...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/ListExecutionsTool](../README.md) / ListExecutionsTool

# Class: ListExecutionsTool

Defined in: [src/tools/execution/ListExecutionsTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L5)
...
> **new ListExecutionsTool**(): `ListExecutionsTool`
...
> **description**: `string` = `'List workflow executions with filtering and pagination options'`

Defined in: [src/tools/execution/ListExecutionsTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `cursor`: `ZodOptional`\<`ZodString`\>; `endDate`: `ZodOptional`\<`ZodString`\>; `includeData`: `ZodDefault`\<`ZodBoolean`\>; `limit`: `ZodDefault`\<`ZodNumber`\>; `startDate`: `ZodOptional`\<`ZodString`\>; `status`: `ZodOptional`\<`ZodEnum`\<\[`"canceled"`, `"crashed"`, `"error"`, `"new"`, `"running"`, `"success"`, `"unknown"`, `"waiting"`\]\>\>; `workflowId`: `ZodOptional`\<`ZodString`\>; \}, `"strip"`, `ZodTypeAny`, \{ `cursor?`: `string`; `endDate?`: `string`; `includeData`: `boolean`; `limit`: `number`; `startDate?`: `string`; `status?`: `"success"` \| `"error"` \| `"unknown"` \| `"canceled"` \| `"crashed"` \| `"new"` \| `"running"` \| `"waiting"`; `workflowId?`: `string`; \}, \{ `cursor?`: `string`; `endDate?`: `string`; `includeData?`: `boolean`; `limit?`: `number`; `startDate?`: `string`; `status?`: `"success"` \| `"error"` \| `"unknown"` \| `"canceled"` \| `"crashed"` \| `"new"` \| `"running"` \| `"waiting"`; `workflowId?`: `string`; \}\>

Defined in: [src/tools/execution/ListExecutionsTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L9)
...
> **name**: `string` = `'list_executions'`

Defined in: [src/tools/execution/ListExecutionsTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L6)
...
Defined in: [src/tools/execution/ListExecutionsTool.ts:19](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L19)
...
Defined in: [src/tools/execution/ListExecutionsTool.ts:111](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ListExecutionsTool.ts#L111)
