...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/MonitorExecutionTool](../README.md) / MonitorExecutionTool

# Class: MonitorExecutionTool

Defined in: [src/tools/execution/MonitorExecutionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L5)
...
> **new MonitorExecutionTool**(): `MonitorExecutionTool`
...
> **description**: `string` = `'Monitor a workflow execution in real-time, providing updates on its progress'`

Defined in: [src/tools/execution/MonitorExecutionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `executionId`: `ZodString`; `includeNodeProgress`: `ZodDefault`\<`ZodBoolean`\>; `maxDuration`: `ZodDefault`\<`ZodNumber`\>; `pollInterval`: `ZodDefault`\<`ZodNumber`\>; \}, `"strip"`, `ZodTypeAny`, \{ `executionId`: `string`; `includeNodeProgress`: `boolean`; `maxDuration`: `number`; `pollInterval`: `number`; \}, \{ `executionId`: `string`; `includeNodeProgress?`: `boolean`; `maxDuration?`: `number`; `pollInterval?`: `number`; \}\>

Defined in: [src/tools/execution/MonitorExecutionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L9)
...
> **name**: `string` = `'monitor_execution'`

Defined in: [src/tools/execution/MonitorExecutionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L6)
...
Defined in: [src/tools/execution/MonitorExecutionTool.ts:26](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L26)
...
Defined in: [src/tools/execution/MonitorExecutionTool.ts:228](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/MonitorExecutionTool.ts#L228)
