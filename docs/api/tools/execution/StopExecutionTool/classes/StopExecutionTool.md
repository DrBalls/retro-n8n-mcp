...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/StopExecutionTool](../README.md) / StopExecutionTool

# Class: StopExecutionTool

Defined in: [src/tools/execution/StopExecutionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L5)
...
> **new StopExecutionTool**(): `StopExecutionTool`
...
> **description**: `string` = `'Stop a running workflow execution'`

Defined in: [src/tools/execution/StopExecutionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `executionId`: `ZodString`; `force`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `executionId`: `string`; `force`: `boolean`; \}, \{ `executionId`: `string`; `force?`: `boolean`; \}\>

Defined in: [src/tools/execution/StopExecutionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L9)
...
> **name**: `string` = `'stop_execution'`

Defined in: [src/tools/execution/StopExecutionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L6)
...
Defined in: [src/tools/execution/StopExecutionTool.ts:16](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L16)
...
Defined in: [src/tools/execution/StopExecutionTool.ts:108](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/StopExecutionTool.ts#L108)
