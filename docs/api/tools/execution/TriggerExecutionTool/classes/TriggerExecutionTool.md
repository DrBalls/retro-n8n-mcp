...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/TriggerExecutionTool](../README.md) / TriggerExecutionTool

# Class: TriggerExecutionTool

Defined in: [src/tools/execution/TriggerExecutionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L5)
...
> **new TriggerExecutionTool**(): `TriggerExecutionTool`
...
> **description**: `string` = `'Trigger a workflow execution with optional input data'`

Defined in: [src/tools/execution/TriggerExecutionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `inputData`: `ZodOptional`\<`ZodRecord`\<`ZodString`, `ZodUnknown`\>\>; `runMode`: `ZodDefault`\<`ZodEnum`\<\[`"manual"`, `"trigger"`, `"webhook"`, `"retry"`, `"integrated"`, `"cli"`\]\>\>; `timeout`: `ZodOptional`\<`ZodNumber`\>; `waitForCompletion`: `ZodDefault`\<`ZodBoolean`\>; `workflowId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `inputData?`: `Record`\<`string`, `unknown`\>; `runMode`: `"retry"` \| `"manual"` \| `"trigger"` \| `"webhook"` \| `"integrated"` \| `"cli"`; `timeout?`: `number`; `waitForCompletion`: `boolean`; `workflowId`: `string`; \}, \{ `inputData?`: `Record`\<`string`, `unknown`\>; `runMode?`: `"retry"` \| `"manual"` \| `"trigger"` \| `"webhook"` \| `"integrated"` \| `"cli"`; `timeout?`: `number`; `waitForCompletion?`: `boolean`; `workflowId`: `string`; \}\>

Defined in: [src/tools/execution/TriggerExecutionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L9)
...
> **name**: `string` = `'trigger_execution'`

Defined in: [src/tools/execution/TriggerExecutionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L6)
...
Defined in: [src/tools/execution/TriggerExecutionTool.ts:23](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L23)
...
Defined in: [src/tools/execution/TriggerExecutionTool.ts:126](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/TriggerExecutionTool.ts#L126)
