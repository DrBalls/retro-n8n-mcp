...
[n8n MCP Server API Documentation](../../../../modules.md) / [tools/execution/ReplayExecutionTool](../README.md) / ReplayExecutionTool

# Class: ReplayExecutionTool

Defined in: [src/tools/execution/ReplayExecutionTool.ts:5](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L5)
...
> **new ReplayExecutionTool**(): `ReplayExecutionTool`
...
> **description**: `string` = `'Replay a previous workflow execution with the same or modified input data'`

Defined in: [src/tools/execution/ReplayExecutionTool.ts:7](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L7)
...
> **inputSchema**: `ZodObject`\<\{ `executionId`: `ZodString`; `modifyData`: `ZodOptional`\<`ZodRecord`\<`ZodString`, `ZodUnknown`\>\>; `timeout`: `ZodOptional`\<`ZodNumber`\>; `waitForCompletion`: `ZodDefault`\<`ZodBoolean`\>; \}, `"strip"`, `ZodTypeAny`, \{ `executionId`: `string`; `modifyData?`: `Record`\<`string`, `unknown`\>; `timeout?`: `number`; `waitForCompletion`: `boolean`; \}, \{ `executionId`: `string`; `modifyData?`: `Record`\<`string`, `unknown`\>; `timeout?`: `number`; `waitForCompletion?`: `boolean`; \}\>

Defined in: [src/tools/execution/ReplayExecutionTool.ts:9](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L9)
...
> **name**: `string` = `'replay_execution'`

Defined in: [src/tools/execution/ReplayExecutionTool.ts:6](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L6)
...
Defined in: [src/tools/execution/ReplayExecutionTool.ts:22](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L22)
...
Defined in: [src/tools/execution/ReplayExecutionTool.ts:177](https://github.com/DrBalls/retro-n8n-mcp/blob/5b51d2f27332cd66340761ded9087bbb57d7ae33/src/tools/execution/ReplayExecutionTool.ts#L177)
