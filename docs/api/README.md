...
- [Version Control Guide](_media/version-control-guide.md) - Comprehensive guide to Git-like version control for workflows
- [Version Control Quick Reference](_media/version-control-quick-reference.md) - Quick command reference
- [Workflow Patterns](_media/version-control-workflow-patterns.md) - Common development patterns and best practices
