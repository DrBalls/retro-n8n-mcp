...
export class ErrorDiagnostics {
     ...
     */
    static diagnoseAuthError(error) {
     ...
     */
    static diagnoseValidationError(error) {
        const message = error.message.toLowerCase();
        const fixes = [];
     ...
     */
    static diagnoseByPattern(error) {
    ...
    static initializePatterns() {
        // JSON parsing errors
        this.errorPatterns.set(/unexpected (token|end of json)/i, {
        ...
        // Memory errors
        this.errorPatterns.set(/out of memory|heap out of memory/i, {
        ...
        // Permission errors
        this.errorPatterns.set(/permission denied|access denied|forbidden/i, {
        ...
        // Workflow errors
        this.errorPatterns.set(/workflow.*(not found|does not exist|invalid)/i, {
     ...
     */
    static prioritizeFixes(diagnosis, errorFrequency) {
...
//# sourceMappingURL=ErrorDiagnostics.js.map