...
export class AuditLogger {
     ...
     * Log a failed action
     */
    logFailure(action, error, context) {
        this.logEvent({
            action,
            result: 'failure',
            details: {
     ...
     */
    logDenied(action, reason, context) {
        this.logEvent({
            action,
            result: 'denied',
