...
export class MergeBranchTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        try {
            // Perform the merge
            const mergeResult = await this.versionControlService.mergeBranch(input.workflowId, input.sourceBranchName, input.targetBranchName, {
...
//# sourceMappingURL=MergeBranchTool.js.map