...
export class BranchMergeTool extends BaseTool {
    ...
    logger = new Logger('BranchMergeTool');
    ...
    async execute(params, context) {
        ...
        try {
            ...
            // Perform the merge
            const mergeResult = await this.versionManager.mergeBranch(input.workflowId, input.sourceBranch, input.targetBranch, {
    ...
    generateMergeRecommendations(mergeResult, input) {
...
//# sourceMappingURL=BranchMergeTool.js.map