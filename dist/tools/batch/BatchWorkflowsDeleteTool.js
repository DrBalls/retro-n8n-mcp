...
export class BatchWorkflowsDeleteTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        const workflowsToDelete = input.workflowIds.map(id => ({
            id,
        ...
        try {
            ...
            const operationId = await batchManager.createBatchOperation('delete', workflowsToDelete, batchOptions);
...
//# sourceMappingURL=BatchWorkflowsDeleteTool.js.map