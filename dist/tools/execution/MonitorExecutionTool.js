...
export class MonitorExecutionTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        try {
            ...
            let lastNodeCount = 0;
            // Initial check
            const initialResponse = await context.apiClient.request('GET', `/executions/${input.executionId}`, { params: { includeData: input.includeNodeProgress } });
            ...
            while (true) {
                ...
                // Get current status
                const response = await context.apiClient.request('GET', `/executions/${input.executionId}`, { params: { includeData: input.includeNodeProgress } });
            ...
            // Timeout reached
            const finalResponse = await context.apiClient.request('GET', `/executions/${input.executionId}`);
...
//# sourceMappingURL=MonitorExecutionTool.js.map