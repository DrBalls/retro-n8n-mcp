...
export class TriggerExecutionTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        try {
            ...
            const response = await context.apiClient.request('POST', '/executions', { data: executionData });
            ...
            while (true) {
                ...
                const statusResponse = await context.apiClient.request('GET', `/executions/${execution.id}`);
...
//# sourceMappingURL=TriggerExecutionTool.js.map