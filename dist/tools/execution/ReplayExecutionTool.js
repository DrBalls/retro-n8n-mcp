...
export class ReplayExecutionTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        try {
            ...
            const originalResponse = await context.apiClient.request('GET', `/executions/${input.executionId}`, { params: { includeData: true } });
            ...
            // Trigger the replay
            const replayResponse = await context.apiClient.request('POST', '/executions', { data: replayData });
            ...
            while (true) {
                ...
                const statusResponse = await context.apiClient.request('GET', `/executions/${replayExecution.id}`, { params: { includeData: true } });
...
//# sourceMappingURL=ReplayExecutionTool.js.map