...
export class StopExecutionTool extends BaseTool {
    ...
    async execute(params, context) {
        ...
        try {
            ...
            const executionResponse = await context.apiClient.request('GET', `/executions/${input.executionId}`);
            ...
            // Stop the execution
            const stopResponse = await context.apiClient.request('POST', `/executions/${input.executionId}/stop`, {
                data: {
                    force: input.force,
                },
            });
...
//# sourceMappingURL=StopExecutionTool.js.map