...
export class MonitoringResourceProvider {
    name = 'monitoring';
    ...
    logger = new Logger('MonitoringResourceProvider');
    constructor(options) {
     ...
     */
    async getWorkflowMetricsById(workflowId) {
        try {
...
//# sourceMappingURL=MonitoringResourceProvider.js.map