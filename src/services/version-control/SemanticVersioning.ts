import { SemanticVersion, SemanticVersionSchema } from '../../types/version-control.types.js';
...
export class SemanticVersioning {
  ...
  static getNextVersion(
    ...
    changeType: 'auto' | 'major' | 'minor' | 'patch' | 'prerelease',
    changes?: { breaking: boolean; features: number; fixes: number }
  ): SemanticVersion {
